...
<tr>
    ...
    <td>
        <a href="edit-student.php?stid=<?php echo htmlentities($result->StudentId);?>" class="btn btn-primary btn-sm">Edit</a>
        <a href="edit-result.php?stid=<?php echo htmlentities($result->StudentId);?>" class="btn btn-warning btn-sm">View Result</a>
    </td>
</tr>
<?php $cnt++; }} ?>
                </tbody>

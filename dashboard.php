...
.sidebar::-webkit-scrollbar-track { background: #1c2530; }
...
.bg1 { background: #2f80ed; }
.bg2 { background: #e74c3c; }
.bg3 { background: #f39c12; }
.bg4 { background: #27ae60; }
...
<div class="main-content" id="main">
    <div class="row g-3">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <a href="manage-students.php" class="card-link">
                <div class="card-box bg1">
                    ...
                    ?>
                    <h3><?php echo htmlentities($row1->total); ?></h3>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <a href="manage-subjects.php" class="card-link">
                <div class="card-box bg2">
                    ...
                    ?>
                    <h3><?php echo htmlentities($row2->total); ?></h3>
                    <p>Total Subjects</p>
                </div>
            </a>
        </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <a href="manage-classes.php" class="card-link">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <a href="manage-results.php" class="card-link">

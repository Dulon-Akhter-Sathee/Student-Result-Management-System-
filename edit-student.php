...
if(isset($_POST['submit'])) {
    $studentname = trim($_POST['fullanme']);
    ...
    $sql = "UPDATE tblstudents SET StudentName=:studentname, RollId=:rollid, StudentEmail=:studentemail, Gender=:gender, ClassId=:classid, DOB=:dob, Status=:status WHERE StudentId=:stid";
...
<!-- Sidebar exactly like Add Student -->
    ...
    <div class="card-box">
        ...
        <form method="post">
            <div class="mb-3">
                ...
                <input type="text" name="fullanme" class="form-control" value="<?php echo htmlentities($student->StudentName); ?>" required>
            </div>

            <div class="mb-3">
                <label class="form-label">Roll ID</label>
                <input type="text" name="rollid" class="form-control" value="<?php echo htmlentities($student->RollId); ?>" maxlength="5" required>
            </div>

            <div class="mb-3">
                <label class="form-label">Email ID</label>
                <input type="email" name="emailid" class="form-control" value="<?php echo htmlentities($student->StudentEmail); ?>" required>
            </div>

            <div class="mb-3">
                <label class="form-label d-block">Gender</label>
                <label class="me-3"><input type="radio" name="gender" value="Male" <?php if($student->Gender=='Male') echo 'checked'; ?>> Male</label>
                <label class="me-3"><input type="radio" name="gender" value="Female" <?php if($student->Gender=='Female') echo 'checked'; ?>> Female</label>
            ...
            <div class="mb-3">
                ...
                <select name="class" class="form-select" required>
                    ...
                    foreach($classes as $c){
                        $selected = ($c->id == $student->ClassId) ? 'selected' : '';
                        echo '<option value="'.htmlentities($c->id).'" '.$selected.'>'.htmlentities($c->ClassName).' Section-'.htmlentities($c->Section).'</option>';
                    }
                    ?>
                </select>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="date" name="dob" class="form-control" value="<?php echo htmlentities($student->DOB); ?>" required>
            </div>

            <div class="mb-3">
                <label class="form-label d-block">Status</label>
                <label class="me-3"><input type="radio" name="status" value="1" <?php if($student->Status=='1') echo 'checked'; ?>> Active</label>
                <label><input type="radio" name="status" value="0" <?php if($student->Status=='0') echo 'checked'; ?>> Block</label>
            </div>
